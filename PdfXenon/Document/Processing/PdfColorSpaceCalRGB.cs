...
{
    public class PdfColorSpaceCalRGB : PdfColorSpace
    {
        ...
        public PdfColorSpaceCalRGB(PdfRenderer renderer, PdfDictionary dictionary)
            : base(renderer)
        {
        ...
        public override PdfColorRGB GetColor()
        {
            ...
            return new PdfColorRGB(RGBSampling(rgb[0]),
                                   RGBSampling(rgb[1]),
                                   RGBSampling(rgb[2]));
        }
